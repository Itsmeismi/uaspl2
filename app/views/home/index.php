                    ...
                    <div class="tab-content" id="dashboardNavContent">
                        ...
                        <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-pill">
                            <div class="chart-area mb-4 mb-lg-0" style="height: 20rem">
                                ...
                                </div><canvas id="myAreaChart" width="968" height="320" style="display: block; width: 968px; height: 320px;" class="chartjs-render-monitor"></canvas>
                            </div>
                        </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="chart-pie mb-4">
                                ...
                                </div><canvas id="myPieChart" width="449" height="240" class="chartjs-render-monitor" style="display: block; width: 449px; height: 240px;"></canvas>
                            </div>
                            <div class="list-group list-group-flush">
                                <div class="list-group-item d-flex align-items-center justify-content-between small px-0 py-2">
                                    <div class="me-3">
                                        <svg class="svg-inline--fa fa-circle fa-w-16 fa-sm me-1 text-blue" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                ...
                                <div class="list-group-item d-flex align-items-center justify-content-between small px-0 py-2">
                                    <div class="me-3">
                                        <svg class="svg-inline--fa fa-circle fa-w-16 fa-sm me-1 text-purple" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                            <path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path>
                                ...
                                <div class="list-group-item d-flex align-items-center justify-content-between small px-0 py-2">
                                    <div class="me-3">
                                        <svg class="svg-inline--fa fa-circle fa-w-16 fa-sm me-1 text-green" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                            <path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path>
